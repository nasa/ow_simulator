...
class FT_Sensor_Check(unittest.TestCase):
  ...
  _FT_TARGET_STOW   = [-4.25, -14.74, -0.15, -0.13, 0.16, -1.70]
  _FT_TARGET_UNSTOW = [15.20, 0.31, -1.47, 0.08, 0.15, -1.11]
  ...
  def test_01_check_ft_sensor_stowed(self):
    ...
    self.assertIsNotNone(self._ft_sensor_msg, "no ft sensor message was received")
    self.assertAlmostEqual(self._ft_sensor_msg[0], self._FT_TARGET_STOW[0], delta=1.0)
    self.assertAlmostEqual(self._ft_sensor_msg[1], self._FT_TARGET_STOW[1], delta=1.0)
    self.assertAlmostEqual(self._ft_sensor_msg[2], self._FT_TARGET_STOW[2], delta=1.0)
    self.assertAlmostEqual(self._ft_sensor_msg[3], self._FT_TARGET_STOW[3], delta=1.0)
    self.assertAlmostEqual(self._ft_sensor_msg[4], self._FT_TARGET_STOW[4], delta=1.0)
    self.assertAlmostEqual(self._ft_sensor_msg[5], self._FT_TARGET_STOW[5], delta=1.0)
