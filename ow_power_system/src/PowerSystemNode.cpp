...
private:
  ...
  high_resolution_clock::time_point m_init_time; // Timestep initialization
...
int main(int argc, char* argv[]) {
  ...
  std::unique_ptr<PCOE::Prognoser> m_prognoser = PrognoserFactory::instance().Create("ModelBasedPrognoser", config);

  // Initial (Empty) GSAP Prediction
  auto init_prediction = m_prognoser->step(initialization_data);

  PowerSystemNode PSNObject;
