...
class DigCircularActionServer(object):
    ...
    def __init__(self,name):
        ...
        self._server = actionlib.SimpleActionServer(self._action_name, ow_lander.msg.DigCircularAction, execute_cb=self.on_DigCircular_action, auto_start = False)
        self._server.start()
    ...
    def _update_motion(self, goal):
        ...
        #plan =  
        self.current_traj  = action_dig_circular.dig_circular(self._interface.move_arm,self._interface.move_limbs, self._interface.robot, goal)
